...
<html lang="en">
  <head>
    ...
    <body>
	<div class="header">
		<h1>Mount Holyoke Library</h1>
		<h3>Gadgets-To-Go Availability Status</h3>
	</div>    
	<div class="container-fluid" style="margin: auto;">      
		<div class="row main">
		<?php if($user->getEquipment('MH') == false) { ?>
			<h4 style="text-align: center;">No Equipment set.  Add some in the admin</h4>
		<?php } else { ?>	
		<?php foreach($user->getEquipment('MH') as $item) { ?>
		...
		<ul class="list-unstyled">
			<li>In addition to what is displayed here and available for immediate check-out, LITS circulates other equipment that must be booked in advance.    Please see <a href="https://www.mtholyoke.edu/lits/tech/borrowing_equipment">Borrowing Equipment</a> for more information.</li>
			<li><a href="https://www.mtholyoke.edu/lits">MHC/LITS Home</a></li>
		</ul>
		</div>
	</footer>
